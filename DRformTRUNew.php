                ...
                <div class="col-lg-12">
					...
					<div class="showback">
						...
						<div class = "form-group">							
							...
							<label><input type="checkbox" value="" id= "requirements" onclick="sample2(this.checked, 'operatorName', 'toda', 'plateNo', 'vehicleMode', 'motorNo', 'chassisNo',  'vehicleNo', 'vehicleColor', 'btnSubmit')">
							...
							<?php
								...
								while($row = mysqli_fetch_object($query)){
									?>
									<div class="checkbox">
								<label><input type="checkbox" value="" name = "requirement" onclick="sample(this.checked, 'operatorName', 'toda', 'plateNo', 'vehicleMode', 'motorNo', 'chassisNo',  'vehicleNo', 'vehicleColor', 'btnSubmit')">
					...
					<div class="showback">
						...
						<div class = "form-group" id='Form1'>							
							...
							<?php
								...
								<select class='form-control' id='toda' name='toda' value='' disabled required>
								<option selected='selected' value='' disabled>TODA Member";	
						...
						function sample(bEnable,operatorName, ownerName, toda, plateNo, vehicleMode, motorNo, chassisNo, vehicleNo, vehicleColor, btnSubmit)
						{
								var isSelected = 0;
								...
								if(isSelected >= o.length){
									...
									document.getElementById(ownerName).disabled = !bEnable;
						...
						function sample2(bEnable,operatorName, ownerName, toda, plateNo, vehicleMode, motorNo, chassisNo, vehicleNo, vehicleColor, btnSubmit){
								var o = document.getElementById("Form1").getElementsByTagName("input");
								var max = o.length;
								if(bEnable){
									var allischecked = (function(){
		...
		<?php
			...
			if(isset($_POST['btnSubmit']))
			{
				...
				if (preg_match('/[\^£$%&*()}{@#~?><>;:,|=_+¬-]/', $operatorName) ||    
					...
					preg_match('/[\^£$%&*()}{@#~?><>,;:|=_+¬-]/', $vehicleMode) || 
					preg_match('/[\^;:£$%&*()}{@#~?><>,|=_+¬-]/', $motorNo) || 
					...
					preg_match('/[\^£$%&*()}{@#~?><>,|=_+;:¬-]/', $vehicleColor))
				{
					...
					$vehicleSQL = "INSERT INTO `tblvehicle` (`strVplateNo`, `strOperatorName`, `strOwnerName`, `strVehicleModel`, `strMotorNo`, `strChassisNo`, `strVehicleNo`, `strVehicleColor`, `intVehicleType`, `strVehicleStat`) VALUES ('$plateNo', '$operatorName', '$name', '$vehicleMode', '$motorNo', '$chassisNo', '$vehicleNo','$vehicleColor', '1', 'Active');";
					
					$truSQL = "INSERT INTO `tbltru` (`strTRUplateNo`, `intTODA`) VALUES ('$plateNo', '$toda');";
					...
					if($vehicleSave == true ){
						...
						echo"<script> alert('$truSQL')</script>";
						if($truSave == true){
							echo"<script> alert('$truSQL')</script>";
