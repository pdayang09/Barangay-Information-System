<div class="form-group">
	...
	$query = mysqli_query($con, "SELECT `strEquipName`,  `intEquipQuantity`, `strStatus` from tblequipment where `intEquipQuantity` > 0 AND `strStatus` = 'Enabled' AND `strEquipCategory`= '9'");
