...
$result=mysqli_query($con,"Select concat(strFirstName,' ',strMiddleName,' ',strLastName,' ',strNameExtension) as 'Name', timestampdiff(YEAR,dtBirthdate,NOW()) as 'Age', charDisable,charGender from tblhousemember where timestampdiff(YEAR,dtBirthdate,NOW())>60 Order by 2");
...
$pdf->SetY(50);
$pdf->SetX(30);	
$pdf->Cell( 158, 12,'Senior Citizen Report' , 0, 0, 'C');
$pdf->SetX(30);	
$pdf->Ln();
$pdf->Cell(20,12,"\n");
...
$pdf->SetX(90);
		$pdf->Cell(45,9,'Person with Disability?',1,0,'C',1);
...
$pdf->SetX(160);
	...
	while ($row = mysqli_fetch_object($result)){
		...
		if($row->charDisable == 'Y'){ $b = "Yes";}
		else{$b= "No";}
		$pdf->SetX(30);
		$pdf->Cell(60,9,$row->Name,1,0,'C');
	
			$pdf->SetX(90);
		$pdf->Cell(45,9,$b,1,0,'C');
