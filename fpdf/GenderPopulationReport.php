...
$pdf->SetY(126);
$pdf->SetX(110);
		$pdf->Cell(80,12,'Total Population: '.$total,1,0,'C');
$pdf->Ln();
$pdf->SetY(150);
$pdf->SetX(100);
...
$new = mysqli_query($con,"Select Upper(concat(strFirstName,' ',strMiddleName,' ',strLastName,' ',strNameExtension)) as 'name',strSign,strPositionName from tblaccount as a inner join tblhousemember as b on a.intForeignMemberNo = b.intMemberNo inner join tblbrgyposition as c on a.intForeignPositionId = c.intPositionId where strOfficerId = 9");
