                ...
                <div class="col-lg-12">
					...
					<div class="showback">
						...
						<div class = "form-group">							
							...
							<label><input type="checkbox" value="" id= "requirements" onclick="sample2(this.checked, 'operatorName', 'plateNo', 'motorNo', 'chassisNo',  'vehicleNo', 'btnSubmit')">
							...
							<?php
								...
								while($row = mysqli_fetch_object($query)){
									?>
									<div class="checkbox">
								<label><input type="checkbox" value="" name = "requirement" onclick="sample(this.checked, 'operatorName', 'plateNo', 'motorNo', 'chassisNo',  'vehicleNo', 'btnSubmit')">
					...
					<div class="showback">
						...
						<div class = "form-group" id='Form1'>							
							...
							<div class="col-sm-4">
								...
								<input id="operatorName" class="form-control input-group-lg reg_name" type="text" name="operatorName" title="system-generated" value = "<?php echo $operatorName;?>"disabled>
							</div>
							<!-- 12-->
							<div class="col-sm-4">
							...
							<div class="col-sm-4">
								...
								<input id="motorNo" class="form-control input-group-lg reg_name" type="text" name="motorNo" title="system-generated" value = "<?php if(isset($_POST['motorNo'])){echo $_POST['motorNo'];}else{} ?>" disabled required>
							</div>
							<div class="col-sm-4">
								<p><font face="cambria" size=5 color="grey"> Chassis No. </font></p>			
								<input id="chassisNo" class="form-control input-group-lg reg_name" type="text" name="chassisNo" title="system-generated" value = "<?php if(isset($_POST['chassisNo'])){echo $_POST['chassisNo'];}else{} ?>"disabled required>
							</div>
							<!-- 12-->
							<div class="col-sm-4">
						...
						function sample(bEnable,operatorName, plateNo, motorNo, chassisNo, vehicleNo, btnSubmit)
						{
								var isSelected = 0;
						...
						function sample2(bEnable, operatorName, plateNo, motorNo, chassisNo, vehicleNo, btnSubmit){
								var o = document.getElementById("Form1").getElementsByTagName("input");
								var max = o.length;
								if(bEnable){
									var allischecked = (function(){
		...
		<?php
			...
			if(isset($_POST['btnSubmit']))
			{
					...
					preg_match('/[\^£$%&*()}{@#~?><>,|=_+¬-;:]/', $vehicleNo) || preg_match('/[\^£$%&*()}{@#~?><>,|=_+¬-;:]/', $chassisNo))
				{
					...
					require('connection.php');
					//SQL Statements 
					$vehicleSQL = "UPDATE `tblvehicle` SET `strOperatorName` = '$operatorName', `strVehicleModel` = '$vehicleMode', `strMotorNo` = '$motorNo', `strChassisNo` = '$chassisNo', `strVehicleNo` = '$vehicleNo'  WHERE `tblvehicle`.`strVplateNo` = '$plateNo'";
					...
					if($vehicleSave == true){
						echo"<script> alert('".$_POST['operatorName']."')</script>";
