...
<div class="form-group" id = "contact-div">				<p><font face = "cambria" size = 4 color = "grey"> Date Died: </font></p>
	<div class="col-sm-9">
		...
		<input id="dtdied" name = 'dtdied' class="form-control input-group-lg reg_name" type= date max = "<?php echo date("Y-m-d"); ?>"> 
		
	</div>
		
</div><br><br><br>
<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
<button type="submit" class="btn btn-default"  value = <?php echo $id?> name = "dec" onclick = "return checkdied()">Submit</button>