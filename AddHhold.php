										...
										<div class = "form-group">
											...
											<div class="form-group" id = "Tin-div">				
												...
												<div class="form-group">				
															...
															function c(value){
																...
																<p><font face = "cambria" size = 4 color = "grey">Educational Attainment:</font></p>
																	...
																	<option>Grade 12</option>
																		...
																		<center><button type = submit  class="btn btn-info" name = "btnsubmit" onClick="return empty()">Submit Record</button></center>
																		<?php
													...
													mysqli_query($con,"INSERT INTO `tblhousemember`( `strFirstName`, `strMiddleName`, `strLastName`, `strNameExtension`, `charGender`, `dtBirthdate`, `strContactNo`, `strOccupation`, `strSSSNo`, `strTINNo`, `intForeignHouseholdNo`,`strCivilStatus`, `strStatus`,`strLifeStatus`,strLiterate,`strEdAttain`,charDisable, `strVotersId`,`dtEntered`) 
													VALUES ('$_Fname','$_Mname','$_Lname','$Ename','$Gender','$Birthdate','$Contact','$Occupation','$SSS','$TIN','$no','$Civil','Head','Alive','$Heduc','$Educa','$Disability','$Vote','$Entered')");
													$_SESSION['Hno'] = $no;
												...
												mysqli_query($con,"INSERT INTO `tblhousemember`( `strFirstName`, `strMiddleName`, `strLastName`, `strNameExtension`, `charGender`, `dtBirthdate`, `strContactNo`, `strOccupation`, `strSSSNo`, `strTINNo`, `intForeignHouseholdNo`,`strCivilStatus`, `strStatus`,`strLifeStatus`,strLiterate,strEdAttain,charDisable, `strVotersId`,`dtEntered`,`strImage`) 
												VALUES ('$_Fname','$_Mname','$_Lname','$Ename','$Gender','$Birthdate','$Contact','$Occupation','$SSS','$TIN','$no','$Civil','Head','Alive','$Heduc','$Educa','$Disability','$Vote','$Entered','$target')");
