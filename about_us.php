<?php include ("head.php"); ?>
    ...
    <div id="content">
    	<div>
        	<h3>About Us</h3>
			<center>
			<img src="images/galas1.jpg" alt="" /> </center>
			 <br>
...
</p><br><p align = "justify">In 1911, Ciriaco de Jesus settles in Galas where he establishes his trade and prospered as a silver & goldsmith specializing in religious icons. Being Childless, Ciriacobrought with him his nephews to whom he passed his skills as a craftsman.
...
</p><br><p align = "justify">When Quezon City was created in the late 1930’s, Galas was integrated as part of the city. Without an official parish within the city, the Galas community continued to hold religious activities at the Holy Trinity Parish Church in Balic-Balic, Sampaloc.
...
The Brgy. Secretary was Rodolfo Lacandazo while Esperanza Tabora served as Brgy. Treasurer. The community that took care of the San Isidro image became BARANGAY SAN ISIDRO. 
</p><br><p align = "justify">Today, local folks, especially the “old timers “, still regard and refer to Barangay 
        ...
        <div id="services">
       	  <div class="services_left">
           	    <div class="block">
                    ...
                    <br> <br> <b> <p> <h3> Hon. John M. Reyno </h3> </p> </b>
					<p> (Punong Barangay) </p>
                </div>
            	<div class="clear" style="height: 35px;"></div>
                <div class="block">
                    <img src="images/img33.jpg" alt="" />
                    <br> <br> <b> <p> <h3> Hon. Rodolfo A. Reyno </h3> </p> </b>
					<p> (Barangay Kagawad) </p>
                </div>
				<div class="clear" style="height: 35px;"></div>
				<div class="block">
                    <img src="images/img33.jpg" alt="" />
                    <br> <br> <b> <p> <h3> Hon. Anthony D. Perez </h3> </p> </b>
					<p> (Barangay Kagawad) </p>
                </div>
				<div class="clear" style="height: 35px;"></div>
                <div class="block">
                    <img src="images/img33.jpg" alt="" />
                    <br> <br> <b> <p> <h3> Hon. Eugene M. Macandog </h3> </p> </b>
					<p> (Barangay Kagawad) </p>
                </div>
          </div>
            <div class="services_right">
            	<div class="block">
                    <img src="images/img33.jpg" alt="" />
                    <br> <br> <b> <p> <h3> Hon. Nemensio E. Villanueva Sr. </h3> </p> </b>
					<p> (Barangay Kagawad) </p>
                </div>
            	<div class="clear" style="height: 35px;"></div>
                <div class="block">
                    <img src="images/img33.jpg" alt="" />
                    <br> <br> <b> <p> <h3> Hon. Manuel A. Casem </h3> </p> </b>
					<p> (Barangay Kagawad) </p>
                </div>
				<div class="clear" style="height: 35px;"></div>
				<div class="block">
                    <img src="images/img33.jpg" alt="" />
                    <br> <br> <b> <p> <h3> Hon. Lorenzo F. Yuson III </h3> </p> </b>
					<p> (Barangay Kagawad) </p>
                </div>
				<div class="clear" style="height: 35px;"></div>
                <div class="block">
                    <img src="images/img33.jpg" alt="" />
                    <br> <br> <b> <p> <h3> Hon. Estrella P. Alcantara </h3> </p> </b>
					<p> (Barangay Kagawad) </p>
                </div>
            </div>
