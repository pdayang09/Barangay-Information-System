...
<section id="main-content"><br>
    <section class="wrapper site-min-height">
		<button class="btn btn-theme" onclick="window.location.href='documentPurpose.php'">Back to the Previous Page</button>
			<form method = POST>
                       <legend ><font face = "cambria" size = 8 color = "grey"> Edit Document Purpose</font></legend>		
				<div class = "showback">
				...
				<?php if(isset($_POST['btnEdit'])){
					...
					if($strDocC == NULL ||$strDocN == NULL ){
						...
						echo "<script> window.location = 'documentPurpose.php' </script> ";}
						else{}
					}				
				}
