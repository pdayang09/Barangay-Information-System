...
<section id="main-content">
	<section class="wrapper site-min-height">		
		...
		<legend ><p><font face = "cambria" size = 5 color = "grey"> Add Spouse </font></p></legend >
			...
			VALUES ('$_Fname','$_Mname','$_Lname','$Ename','$Gend','$bday','$contact','$occup','$SSS','$TIN','$Hno','$civil','Spouse','Alive','$Vote','$Entered','$Disability','$Heduc','$Educa')");
			echo "<script>window.location = 'HholdPersonal.php'</script>";
		}
		...
		VALUES ('$_Fname','$_Mname','$_Lname','$Ename','$Gend','$bday','$contact','$occup','$SSS','$TIN','$Hno','$civil','Spouse','Alive','$Vote','$Entered','$target','$Disability','$Heduc','$Educa')");
