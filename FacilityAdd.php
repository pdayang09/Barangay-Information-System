...
<!-- DIV END-->
			 ...
			 if (isset($_POST['btnAdd'])){
				 ...
				 if($strcode == NULL ||$strname == 'Select Category' ||$strStatus == NULL  ){
					 ...
					 mysqli_query($con,"INSERT INTO `tblfacility`(`strFaciName`, `strFaciCategory`, `strFaciStatus`, `dblFaciDayCharge`, `dblFaciNightCharge`,`dblFaciNResidentCharge`,`uploadImage`) VALUES ('$strcode','$strname','$strStatus','$strdayprice','$strnightprice','$strresidentprice','$newname');");
